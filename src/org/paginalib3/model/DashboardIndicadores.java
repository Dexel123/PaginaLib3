...
public class DashboardIndicadores {
    ...
    public int getLibrosActivos() { return librosActivos; }
    public void setLibrosActivos(int librosActivos) { this.librosActivos = librosActivos; }
    public int getUnidadesEnStock() { return unidadesEnStock; }
    public void setUnidadesEnStock(int unidadesEnStock) { this.unidadesEnStock = unidadesEnStock; }
    public double getInventarioValorizadoCosto() { return inventarioValorizadoCosto; }
    public void setInventarioValorizadoCosto(double inventarioValorizadoCosto) { this.inventarioValorizadoCosto = inventarioValorizadoCosto; }
    ...
    public int getLibrosStockCritico() { return librosStockCritico; }
    public void setLibrosStockCritico(int librosStockCritico) { this.librosStockCritico = librosStockCritico; }
}
