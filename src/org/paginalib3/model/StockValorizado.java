...
public class StockValorizado {
    ...
    public StockValorizado(String isbn, String titulo, int stockActual, double costoPromedio, double precio, double valorCosto, double valorVenta, double margenPotencial) {
        this.isbn=isbn; this.titulo=titulo; this.stockActual=stockActual; this.costoPromedio=costoPromedio; this.precio=precio; this.valorCosto=valorCosto; this.valorVenta=valorVenta; this.margenPotencial=margenPotencial;
    }
    ...
    public double getValorCosto() { return valorCosto; }
    public double getValorVenta() { return valorVenta; }
    public double getMargenPotencial() { return margenPotencial; }
}
