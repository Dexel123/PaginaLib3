...
public class VentaController {
    ...
    @FXML
    private TextField txtCuiCliente, txtFiltroLibro, txtCantidad, txtDescuento, txtUsuarioAutoriza;
    @FXML
    private PasswordField txtClaveAutoriza;
    @FXML
    private TableView<Libro> tblLibros;
    @FXML
    private TableColumn<Libro, String> colLibroIsbn, colLibroTitulo;
    @FXML
    ...
    @FXML
    private TableColumn<DetalleVenta, Double> colCarritoPrecio, colCarritoSubtotal;
    @FXML
    private Label lblSubtotal, lblDescuento, lblTotal, lblEstado;
    ...
    private void cargarClientes() {
        try {
            ...
            lblEstado.setText("No se pudieron cargar clientes: " + e.getMessage());
        }
    }
    ...
    private void seleccionarCliente() {
        ...
        if (c != null) {
            txtCuiCliente.setText(c.getCuiCliente());
        }
    }
    ...
    private void agregar() {
        ...
        try {
            ...
            if (total > l.getStockActual()) {
                alert(Alert.AlertType.WARNING, "Stock insuficiente. Disponible: " + l.getStockActual());
                return;
            }
            if (d == null) {
