...
public class LibroDAOImpl implements LibroDAO {
    ...
    public List<Libro> listarTodos() throws SQLException {
        ...
        try (
                Connection c = Conexion.getInstancia().conectar(); CallableStatement s = c.prepareCall("{CALL sp_listarlibros()}"); ResultSet r = s.executeQuery()) {
    ...
    public List<Libro> buscar(String texto) throws SQLException {
        ...
        try (
                Connection c = Conexion.getInstancia().conectar(); CallableStatement s
                = c.prepareCall("{CALL sp_buscar_libros(?)}")) {
    ...
    public Libro buscarPorIsbn(String isbn) throws SQLException {
        ...
        try (
                Connection c = Conexion.getInstancia().conectar(); CallableStatement s
                = c.prepareCall("{CALL sp_buscarlibro(?)}")) {
    ...
    public boolean insertar(Libro libro) throws SQLException {
        ...
        try (
                Connection c = Conexion.getInstancia().conectar(); CallableStatement s
                = c.prepareCall("{CALL sp_insertarlibro(?,?,?,?,?,?)}")) {
    ...
    public List<Libro> listarStockCritico()
        ...
        stock_minimo,nombre_categoria
        FROM vw_stock_critico
        ORDER BY stock_actual,titulo
        """;

        try (
                Connection c = Conexion.getInstancia().conectar(); PreparedStatement s
                = c.prepareStatement(sql); ResultSet r = s.executeQuery()) {
    ...
    private Libro map(ResultSet r)
            throws SQLException {

        Date fecha
                = has(r, "fecha_publicacion")
                ? r.getDate("fecha_publicacion")
                : null;
